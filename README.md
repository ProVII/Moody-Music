...
Unfortunately, this is not the case right now since the application is not published. Anyone who'd like to use this application, would've to be pre-authorized within the app's facebook/twitter page. Therefore, you've 2 options from here:
  ...
  2. This is the longer option, which may prove to be too troublesome. Basically any twitter/facebook status update goes through the Moody Dictionary algorithm, therefore, you can edit the script within the index page body, and simply add a hardcoded custom call to that algorithm with any quote you wanna try, for instance 'moodyDictionary("This is a test post, I'm feeling good today")'.
